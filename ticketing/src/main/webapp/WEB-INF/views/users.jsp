...
<c:url
	value="/resources/js/usersFilter.js"
	var="usersFilterJs"
/>
<script
...
<body>
	<section class="container">
		...
		>
			<thead>
				<tr>
					<th><spring:message code="users.table.head.num" /></th>
					<th><spring:message code="users.table.head.role" /></th>
					<th><spring:message code="users.table.head.username" /></th>
					<th><spring:message code="users.table.head.full.name" /></th>
					<th><spring:message code="users.table.head.ext" /></th>
					<th><spring:message code="users.table.head.location" /></th>
			...
			<tbody>
				...
				>
					<tr>
						...
						<td><spring:message code="user.role.${user.role}" /></td>
						<td>${user.username}</td>
						<td>${user.fullName}</td>
						...
						<c:choose>
							...
							<c:otherwise>
								<td><spring:message code="users.table.body.external" />
									&nbsp;${user.location}</td>
							</c:otherwise>
						</c:choose>
						<sec:authorize access="hasAnyAuthority('SUPERVISOR' )">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					> <span class="glyphicon glyphicon-trash"> </span> <spring:message
							code="users.confirm.remove.button"
						/>
					</a>
					<button
						type="button"
